...
<body>
	<div class="container"
		...
		<form action="${pageContext.request.contextPath}/Operation"
			...
			<input type="hidden" name="form" value="updatepasswordno">
			<center>
				<input type="submit" name="updatepasswordno"value="updatepassword" class="btn btn-secondary"onclick="validatePassword();" />
			</center>
